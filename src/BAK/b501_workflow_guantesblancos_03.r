...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0016", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0016", "DT0016" )

  DR_drifting_guantesblancos( "DR0016", "CA0016" )
  FE_historia_guantesblancos( "FE0016", "DR0016" )

  TS_strategy_guantesblancos_202109( "TS0016", "FE0016" )

  HT_tuning_guantesblancos( "HT0016", "TS0016" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0016", c("HT0016","TS0016") )
...
# DT0003, CA0003, DR0003, FE0003, TS0003, HT0003 y ZZ0003
corrida_guantesblancos_202109( "gb10" )


# Luego partiendo de  FE0003
# genero TS0004, HT0004 y ZZ0004
