...
PARAM$finalmodel$num_iterations <- 412
PARAM$finalmodel$learning_rate <- 0.0481865173481896
PARAM$finalmodel$feature_fraction <- 0.674755890923552
PARAM$finalmodel$min_data_in_leaf <- 2053
PARAM$finalmodel$num_leaves <- 46215
PARAM$finalmodel$is_unbalance <- TRUE
PARAM$finalmodel$lambda_l1 <- 0.511566009631173
PARAM$finalmodel$lambda_l2 <- 0.427538663000127
PARAM$finalmodel$min_gain_to_split <- 0.708351490417651
PARAM$finalmodel$max_depth <- 19
