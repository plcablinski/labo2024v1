...
PARAM$semillas <- c(244823,245027,246121,251473,258539,100019, 110023, 120041, 130043, 140053)
...
for (vpeso in c(1,1.1,1.2,1.3)) {
  ...
  for (vmin_cp in c(-0.5)) {
    for (vmax_depth in c(6, 8, 7, 5)) {
      for (vmin_split in c(1500, 1400, 1300, 1200, 1100, 1000, 900, 850, 825, 800, 700, 600, 500, 400, 300, 200, 100  )) {
        for (vmin_bucket in c(10,20,40,80,160,250,320,450,500,600,700,800)) {
