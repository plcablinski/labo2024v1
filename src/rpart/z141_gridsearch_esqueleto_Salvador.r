...
archivo_salida <- "./exp/HT2020/gridsearch_Salvador.txt"
...
for (vmax_depth in c(10)) {
  for (vmin_split in c(700,800)) {
    # notar como se agrega+

    # vminsplit  minima cantidad de registros en un nodo para hacer el split
    param_basicos <- list(
      "cp" = -0.9, # complejidad minima
      "minsplit" = vmin_split,
      "minbucket" = 240, # minima cantidad de registros en una hoja
      "maxdepth" = vmax_depth
