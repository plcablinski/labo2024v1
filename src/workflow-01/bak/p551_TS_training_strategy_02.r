...
# en la columna numero_de_cliente seteo en nulo a todos los que foto_mes not in  PARAM$future
#dataset[
#  !foto_mes %in% PARAM$future,
...
# para los meses [foto_mes %in% PARAM$final_train] creo un nuevo dataset que tenga numero_de_cliente en nulo demás datos dejo igual
