...
corrida_m_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  DT_incorporar_dataset_default( "DT0012", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0012", "DT0012" )

  DR_drifting_guantesblancos( "DR0012", "CA0012" )
  FE_historia_guantesblancos( "FE0012", "DR0012" )

  TS_strategy_guantesblancos_202107( "TS0012", "FE0012" )

  HT_tuning_guantesblancos( "HT0012", "TS0012" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0012", c("HT0012","TS0012") )
